...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center py-5 mx-8 sm:mx-20 x1:mx-32'>
      ...
      <button onClick={()=>navigate('/admin')} className='flex items-center gap-2 rounded-full text-sm cursor-pointer text-white px-10 py-2.5' style={{backgroundColor: '#5044E5'}}>
        Login
